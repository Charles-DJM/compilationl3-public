...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void caseAIfinstr(AIfinstr node)
    {
        ...
        if(node.getIfinstrbis() != null)
        {
            node.getIfinstrbis().apply(this);
        }
        outAIfinstr(node);
    }

    public void inAElseIfinstrbis(AElseIfinstrbis node)
    {
        defaultIn(node);
    }

    public void outAElseIfinstrbis(AElseIfinstrbis node)
    {
        defaultOut(node);
    }
    ...
    public void caseAElseIfinstrbis(AElseIfinstrbis node)
    {
        ...
        outAElseIfinstrbis(node);
    }

    public void inANoelseIfinstrbis(ANoelseIfinstrbis node)
    {
        defaultIn(node);
    }

    public void outANoelseIfinstrbis(ANoelseIfinstrbis node)
    {
        defaultOut(node);
    }
    ...
    {
        inANoelseIfinstrbis(node);
        outANoelseIfinstrbis(node);
    }

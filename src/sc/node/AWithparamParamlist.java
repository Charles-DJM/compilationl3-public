...
public final class AWithparamParamlist extends PParamlist
{
    private TLPar _lPar_;
    private PVardeclist _vardeclist_;
    private TRPar _rPar_;

    public AWithparamParamlist()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AWithparamParamlist(
    ...
    {
        ((Analysis) sw).caseAWithparamParamlist(this);
    }

...
public class Parser
{
    ...
    private void reduce_0(int reduction) throws IOException, LexerException, ParserException
    {
        switch(reduction)
        {
            ...
            break;
            case 49: /* reduce AIfthenIfinstr */
            {
                ArrayList<Object> list = new49();
                push(goTo(19), list, false);
            }
            break;
            case 50: /* reduce AIfthenelseIfinstr */
            {
                ArrayList<Object> list = new50();
                push(goTo(19), list, false);
            }
            break;
            case 51: /* reduce AElseinstr */
            {
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    ArrayList<Object> new49() /* reduce AIfthenIfinstr */
    {
        @SuppressWarnings("hiding") ArrayList<Object> nodeList = new ArrayList<Object>();
        ...
        pifinstrNode1 = new AIfthenIfinstr(tifNode2, pexpNode3, tthenNode4, pinstrblocNode5);
        }
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    ArrayList<Object> new50() /* reduce AIfthenelseIfinstr */
    {
        @SuppressWarnings("hiding") ArrayList<Object> nodeList = new ArrayList<Object>();
        ...
        TThen tthenNode4;
        PInstrbloc pinstrblocNode5;
        PElseinstr pelseinstrNode6;
        tifNode2 = (TIf)nodeArrayList1.get(0);
        pexpNode3 = (PExp)nodeArrayList2.get(0);
        tthenNode4 = (TThen)nodeArrayList3.get(0);
        pinstrblocNode5 = (PInstrbloc)nodeArrayList4.get(0);
        pelseinstrNode6 = (PElseinstr)nodeArrayList5.get(0);

        pifinstrNode1 = new AIfthenelseIfinstr(tifNode2, pexpNode3, tthenNode4, pinstrblocNode5, pelseinstrNode6);
        }
	nodeList.add(pifinstrNode1);
        return nodeList;
    }
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    ArrayList<Object> new51() /* reduce AElseinstr */
    {
        @SuppressWarnings("hiding") ArrayList<Object> nodeList = new ArrayList<Object>();

        @SuppressWarnings("unused") ArrayList<Object> nodeArrayList2 = pop();
        @SuppressWarnings("unused") ArrayList<Object> nodeArrayList1 = pop();
        PElseinstr pelseinstrNode1;
        {
            // Block
        TElse telseNode2;
        ...
        pelseinstrNode1 = new AElseinstr(telseNode2, pinstrblocNode3);
        }
	nodeList.add(pelseinstrNode1);
        return nodeList;
    }
...
/*      {
			{{-1, REDUCE, 4}, {17, SHIFT, 1}, {27, SHIFT, 2}, },
			{{-1, ERROR, 1}, {27, SHIFT, 9}, },
			{{-1, ERROR, 2}, {4, SHIFT, 10}, },
			{{-1, ERROR, 3}, {28, ACCEPT, -1}, },
			{{-1, REDUCE, 4}, {27, SHIFT, 2}, },
			{{-1, REDUCE, 1}, },
			{{-1, REDUCE, 4}, {27, SHIFT, 2}, },
			{{-1, ERROR, 7}, {16, SHIFT, 14}, },
			{{-1, REDUCE, 10}, {15, SHIFT, 15}, },
			{{-1, REDUCE, 13}, {6, SHIFT, 17}, },
			{{-1, ERROR, 10}, {5, SHIFT, 18}, {17, SHIFT, 1}, },
			{{-1, ERROR, 11}, {8, SHIFT, 20}, {17, SHIFT, 1}, },
			{{-1, REDUCE, 0}, },
			{{-1, REDUCE, 3}, },
			{{-1, REDUCE, 2}, },
			{{-1, ERROR, 15}, {17, SHIFT, 1}, },
			{{-1, REDUCE, 9}, },
			{{-1, ERROR, 17}, {26, SHIFT, 24}, },
			{{-1, REDUCE, 8}, },
			{{-1, ERROR, 19}, {5, SHIFT, 25}, },
			{{-1, REDUCE, 60}, {8, SHIFT, 20}, {16, SHIFT, 26}, {18, SHIFT, 27}, {21, SHIFT, 28}, {23, SHIFT, 29}, {25, SHIFT, 30}, {27, SHIFT, 31}, },
			{{-1, ERROR, 21}, {8, SHIFT, 20}, },
			{{-1, REDUCE, 6}, },
			{{-1, REDUCE, 12}, {15, SHIFT, 15}, },
			{{-1, ERROR, 24}, {7, SHIFT, 46}, },
			{{-1, REDUCE, 7}, },
			{{-1, REDUCE, 57}, },
			{{-1, ERROR, 27}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 28}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 29}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 30}, {4, SHIFT, 61}, },
			{{-1, REDUCE, 15}, {4, SHIFT, 62}, {6, SHIFT, 63}, },
			{{-1, ERROR, 32}, {12, SHIFT, 64}, },
			{{-1, REDUCE, 60}, {8, SHIFT, 20}, {16, SHIFT, 26}, {18, SHIFT, 27}, {21, SHIFT, 28}, {23, SHIFT, 29}, {25, SHIFT, 30}, {27, SHIFT, 31}, },
			{{-1, REDUCE, 40}, },
			{{-1, REDUCE, 41}, },
			{{-1, REDUCE, 42}, },
			...
			{{-1, REDUCE, 46}, },
			{{-1, REDUCE, 47}, },
			{{-1, ERROR, 43}, {9, SHIFT, 67}, },
			{{-1, REDUCE, 5}, },
			{{-1, REDUCE, 11}, },
			{{-1, REDUCE, 14}, },
			{{-1, ERROR, 47}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 48}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 49}, {4, SHIFT, 70}, },
			{{-1, REDUCE, 32}, },
			{{-1, REDUCE, 34}, },
			{{-1, ERROR, 52}, {10, SHIFT, 71}, {19, SHIFT, 72}, },
			{{-1, REDUCE, 18}, {11, SHIFT, 73}, },
			{{-1, REDUCE, 20}, {12, SHIFT, 74}, {13, SHIFT, 75}, },
			{{-1, REDUCE, 23}, {0, SHIFT, 76}, {1, SHIFT, 77}, },
			{{-1, REDUCE, 26}, {2, SHIFT, 78}, {3, SHIFT, 79}, },
			{{-1, REDUCE, 29}, },
			{{-1, REDUCE, 33}, },
			{{-1, ERROR, 59}, {10, SHIFT, 71}, {22, SHIFT, 80}, },
			{{-1, ERROR, 60}, {10, SHIFT, 71}, {16, SHIFT, 81}, },
			{{-1, ERROR, 61}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, REDUCE, 37}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 63}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 64}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, REDUCE, 59}, },
			{{-1, REDUCE, 53}, },
			{{-1, REDUCE, 58}, },
			{{-1, ERROR, 68}, {5, SHIFT, 87}, {10, SHIFT, 71}, },
			{{-1, REDUCE, 30}, },
			{{-1, ERROR, 70}, {5, SHIFT, 88}, },
			{{-1, ERROR, 71}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 72}, {8, SHIFT, 20}, },
			{{-1, ERROR, 73}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 74}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 75}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 76}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 77}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 78}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 79}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, ERROR, 80}, {8, SHIFT, 20}, },
			{{-1, REDUCE, 55}, },
			{{-1, ERROR, 82}, {5, SHIFT, 99}, {10, SHIFT, 71}, },
			{{-1, REDUCE, 39}, {10, SHIFT, 71}, {15, SHIFT, 100}, },
			{{-1, ERROR, 84}, {5, SHIFT, 102}, },
			{{-1, ERROR, 85}, {7, SHIFT, 103}, {10, SHIFT, 71}, },
			{{-1, ERROR, 86}, {10, SHIFT, 71}, {16, SHIFT, 104}, },
			{{-1, REDUCE, 31}, },
			{{-1, REDUCE, 35}, },
			{{-1, REDUCE, 17}, {11, SHIFT, 73}, },
			{{-1, REDUCE, 49}, {20, SHIFT, 105}, },
			{{-1, REDUCE, 19}, {12, SHIFT, 74}, {13, SHIFT, 75}, },
			{{-1, REDUCE, 21}, {0, SHIFT, 76}, {1, SHIFT, 77}, },
			{{-1, REDUCE, 22}, {0, SHIFT, 76}, {1, SHIFT, 77}, },
			{{-1, REDUCE, 24}, {2, SHIFT, 78}, {3, SHIFT, 79}, },
			{{-1, REDUCE, 25}, {2, SHIFT, 78}, {3, SHIFT, 79}, },
			{{-1, REDUCE, 27}, },
			{{-1, REDUCE, 28}, },
			{{-1, REDUCE, 52}, },
			{{-1, ERROR, 99}, {16, SHIFT, 107}, },
			{{-1, ERROR, 100}, {4, SHIFT, 47}, {14, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, REDUCE, 36}, },
			{{-1, REDUCE, 54}, },
			{{-1, REDUCE, 16}, },
			{{-1, REDUCE, 48}, },
			{{-1, ERROR, 105}, {8, SHIFT, 20}, },
			{{-1, REDUCE, 50}, },
			{{-1, REDUCE, 56}, },
			{{-1, REDUCE, 39}, {10, SHIFT, 71}, {15, SHIFT, 100}, },
			{{-1, REDUCE, 51}, },
...
/*      {
			...
			{{-1, 8}, {15, 23}, },
			{{-1, 51}, {20, 32}, {33, 32}, },
			{{-1, 52}, {28, 59}, {29, 60}, {47, 68}, {61, 82}, {62, 83}, {63, 85}, {64, 86}, {100, 108}, },
			{{-1, 53}, {71, 89}, },
			{{-1, 54}, {73, 91}, },
			{{-1, 55}, {74, 92}, {75, 93}, },
			{{-1, 56}, {76, 94}, {77, 95}, },
			{{-1, 57}, {48, 69}, {78, 96}, {79, 97}, },
			{{-1, 84}, },
			{{-1, 101}, {108, 110}, },
			{{-1, 33}, },
			{{-1, 34}, },
			...
			{{-1, 40}, },
			{{-1, 41}, },
			{{-1, 42}, {11, 22}, {21, 44}, {72, 90}, {80, 98}, {105, 109}, },
			{{-1, 43}, {33, 65}, },
        };*/
...
/*      {
			...
			"expecting: '|', ';'",
			"expecting: '(', ')', '!', 'lire', number, id",
			"expecting: '{', '}', ';', 'si', 'sinon', 'tantque', 'retour', 'ecrire', id, EOF",
			"expecting: ')', '|'",
			"expecting: ')', '|', ','",
			"expecting: ']', '|'",
			"expecting: '{', '}', ';', 'si', 'sinon', 'tantque', 'retour', 'ecrire', id",
        };*/
    private static int[] errors;
/*      {
			0, 1, 2, 3, 4, 3, 4, 5, 6, 7, 8, 9, 3, 3, 10, 11, 12, 13, 9, 14, 15, 16, 4, 6, 17, 9, 15, 18, 18, 18, 2, 19, 20, 15, 15, 15, 15, 15, 5, 15, 15, 15, 15, 21, 4, 12, 6, 18, 18, 2, 22, 22, 23, 24, 25, 26, 22, 22, 22, 27, 28, 18, 29, 18, 18, 21, 15, 30, 31, 22, 14, 18, 16, 18, 18, 18, 18, 18, 18, 18, 16, 15, 31, 32, 14, 33, 28, 22, 22, 24, 34, 25, 26, 26, 22, 22, 22, 22, 15, 5, 18, 14, 22, 22, 15, 16, 15, 15, 32, 15, 14, 
        };*/
